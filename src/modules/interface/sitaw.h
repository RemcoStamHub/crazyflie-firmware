...
/* Configuration options for the 'Crash' detection. */
#define SITAW_CR_ACC_THRESHOLD (6.0f)     /* The maximum acc value indicating a Crash situation. */
#define SITAW_CR_ACC_TRIGGER_COUNT 10      /* The number of consecutive tests for Crash to be detected. Configured for 250Hz testing. */
#define SITAW_CR_IN_FLIGHT_THRESHOLD 1000  /* Minimum summed motor PWM that means we are flying */
...
//#define SITAW_CR_LOG_ENABLED       /* Uncomment to enable LOG framework for the Crash detection trigger object. */
